<template>
    <div class="bg-purple-900 text-coolGray-300 py-6">
        <div class="brand flex space-x-2 text-3xl">
            ...
            <h1 class="font-thin">
                Chit<span class="fontbold text-yellow-300">Chat</span>
                </h1>
        </div>
        <div class="menu">
            ...
            <div v-else class="flex items-cenetr space-x-8">
...
<script setup>
import { authetication } from '-/helpers/useFirebase'

const { isAuthenticated, user, googlePopup, sigOut } = authetication()
</script>